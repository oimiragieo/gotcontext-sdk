...
The raw MCP server exposes ~126 low-level tools (AST traversal, skeleton reads,
graph search, …). Agents fumble when they see that many. This plugin curates
them into five **outcome-shaped skills** Claude can reason about at the task
level — matching the
...
- Source: <https://github.com/oimiragieo/gotcontext-main/tree/main/plugins/gotcontext>
